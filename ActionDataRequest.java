...
public class ActionDataRequest extends javax.swing.JPanel {
    ...
    void labelComponents() {
        ...
        String title = se.getString("aBoxDataRequest");
        setBorder(javax.swing.BorderFactory.createTitledBorder(title));
        String str = se.getString("keepActive");
        keepActiveBtn.setText(str);
        str = se.getString("markCompleted");
        markCompletedBtn.setText(str);
        str = se.getString("dONE");
        doneBtn.setText(str);
        str = se.getString("returnOften");
        jLabel1.setText(str);
        str = se.getString("whenDoneMarkCompleted");
        jLabel2.setText(str);
        str = se.getString("andHitDone");
        jLabel3.setText(str);
        str = se.getString("goToChart");
        chartBtn.setText(str);
    }
