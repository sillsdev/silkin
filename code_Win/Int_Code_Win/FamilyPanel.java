...
public class FamilyPanel extends JPanel {
    ...
    void labelComponents() {
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, 
            se.getString("selectedFamily"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, 
            javax.swing.border.TitledBorder.DEFAULT_POSITION, null, 
            new java.awt.Color(0, 51, 204)));
        jLabel3.setText(se.getString("family#"));
        jLabel4.setText(se.getString("start"));
        famStartMM.setText(se.getString("mm"));
        famStartYear.setText(se.getString("yyyy"));
        jLabel14.setText(se.getString("end"));
        famEndMM.setText(se.getString("mm"));
        famEndYear.setText(se.getString("yyyy"));
        jLabel15.setText(se.getString("reason"));
        reasonBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] 
            { se.getString("na"), se.getString("death"), 
            se.getString("divorce"), se.getString("other") })); 
        jLabel6.setText(se.getString("husband"));
        husbandName.setText(se.getString("husbandNameID"));
        jLabel7.setText(se.getString("wife"));
        jLabel13.setText(se.getString("children"));
        jLabel2.setText(se.getString("notesOnFamily"));
        wifeName.setText(se.getString("wifeNameID"));
        familyID.setText(se.getString("nnn"));
        famStartDD.setText(se.getString("dd"));
        famEndDD.setText(se.getString("dd"));
...
//        dirty = true;
    ...
    public void showInfo(Family fam) {
        ...
        int reason = 0;
        if (fam.reason.equals(se.getString("death"))) { reason = 1;
        } else if (fam.reason.equals(se.getString("divorce"))) { reason = 2;
        } else if (fam.reason.equals(se.getString("other"))) { reason = 3;
        }
...
//     order.
    ...
    void storeInfo(Family infoMarriage) throws KSParsingErrorException,
        ...
        storing = true;
        String a, b, c;
        a = (String)reasonBox.getSelectedItem();
        infoMarriage.reason = (a.equals("N/A") ? "NA" : a);
        ...
        if (! infoMarriage.getMarriageDate().equals(UDate.formatAsXSD(b, a, c))) {
            ...
            if (! ok) {
                c = msgs.getString("invalidMarriageDate") + b + "-" + a + "-" + c;
        ...
        if (! infoMarriage.getDivorceDate().equals(UDate.formatAsXSD(b, a, c)))  {
            ...
            if (! ok) {
                c = msgs.getString("invalidMarriageEndDate") + b + "-" + a + "-" + c;
                throw new KSDateParseException(c);
            }
        }
     ...
     * to squares.
     * 
     * @param s the string from which banned characters are to be removed
