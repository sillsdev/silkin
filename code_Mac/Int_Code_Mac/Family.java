...
public class Family extends Marriage implements Serializable, Locatable {
    ...
    Family(Individual person1, Individual person2, String argName1, String argName2, boolean divReq, TreeMap divSpecs)
        ...
        if ((divSpec1 != null) && (divSpec2 != null) && (!(divSpec1.equals(divSpec2)))) {
            ...
            if (divReq) {
                ...
                String msg = msgs.getString("divSpec1") + " " + argName1 + " "
                        + msgs.getString("and") + " " + argName2 + ",";
                msg += msgs.getString("divSpec2") 
                        + argName1 + " " + msgs.getString("divSpec3") + divSpec1 + ">\n"
                        + argName2 + " " + msgs.getString("divSpec3") + divSpec2 + ">.";
    ...
    */
    public String toString() {
        ...
        String hSerial = (husband == null ? se.getString("none") : "#" + husband.serialNmbr);
        String wSerial = (wife == null ? se.getString("none") : "#" + wife.serialNmbr);
        image += "\n     H =  " + hSerial + ", W =";
        image += " " + wSerial + ".\n";
        image += "     " + children.size();
        if (children.size() != 1) {
...
//    }
    ...
    public void addParent(Individual mate) throws KSInternalErrorException {
        if (mate.gender.equals("F")) {
            if (wife == null) {
                ...
                throw new KSInternalErrorException("Family.addSpouse " 
                        + msgs.getString("secondWife"));
            }
        } else {
            if (husband == null) {
                husband = mate;
    ...
    public void deleteSpouse(Individual mate) throws KSInternalErrorException {
        if (mate == husband) {
            ...
            throw new KSInternalErrorException("Family.deleteSpouse " 
                    + msgs.getString("unknownEx"));
        }
    ...
    * But do not alter the data change date. (for use in parsing)
    ...
    public void deleteChild(Individual kid) throws KSInternalErrorException {
        if (children.contains(kid)) {
            ...
            throw new KSInternalErrorException("Family.deleteSpouse " 
                    + msgs.getString("unknownKid"));
        }
    }  // end of method deleteChild

    /**
    Delete this Family. Remove it from the marriages list of any spouses. 
     */
    public void delete() {
        deleted = true;
        homeChart = "deleted";
