...
public class EditPrefsWindow extends JFrame {
    ...
    void loadValues() {
        ...
        setTitle(se.getString("editPrefsFor") + " " + fileName);
        loading = false;
    }
    ...
    void labelComponents() {
        polygamyCkBox.setText(se.getString("polygamyPermitted"));
        inductionCkBox.setText(se.getString("doPureInduction"));
        ignorableLabel.setText(se.getString("ignorable%"));
        subpatternCkBox.setText(se.getString("subPatternMatches"));
        maxLabel.setText(se.getString("max%"));
        doneBtn.setText(se.getString("dONE"));
        surnameCheckBox.setText(se.getString("surnameNormallyCaptured"));
        birthdateCheckBox.setText(se.getString("birthDateNormallyCaptured"));
        snapToGridCkBox.setText(se.getString("snap"));
        editLinkPrioritiesBtn.setText(se.getString("inspectEditKinTypePriorities"));
        wideLabel.setText(se.getString("wide"));
    ...
    private void wideTxtFldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_wideTxtFldFocusLost
        ...
        try {
            ...
            String msg = msgs.getString("20To120"),
                   ttl = msgs.getString("invalidGridWidth");
    ...
    private void highTxtFldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_highTxtFldFocusLost
        ...
        try {
            ...
            String msg = msgs.getString("40To180"),
                   ttl = msgs.getString("invalidGridHeight");
            JOptionPane.showMessageDialog(SIL_Edit.edWin, msg, ttl, JOptionPane.WARNING_MESSAGE);
            wideTxtFld.setText(String.valueOf(Library.gridX));
            return;
        }
