 ...
 * The miViewMe field, when non-null, holds a pointer to this frame's entry in 
 * a "View" menu.
 * <p>
 * This class handles the tidying up of the View menu when a window is closed, 
 * and the Listener which brings this window to the top when it is chosen from 
 * the View menu. </p>
 * 
...
public class KSJInternalFrame extends JInternalFrame 
    ...
    public void internalFrameClosing(InternalFrameEvent e) {
        if ((menuView != null) && (miViewMe != null)) {
            menuView.remove(miViewMe);
        }
        ...
        } else if (this instanceof ContextEditor) {
