 ...
 * lists.  Collectively, these vector elements define the high-level 
 * characteristics of a {@link DomainTheory}. This vector will be used to
 * compare any two <code>DomainTheories</code> and compute their similarity.
 * <p>
* NOTE: All messages in this class are intended for the Developer or 
* Administrator. They are not internationalized.
* </p>
