...
/**  This class defines a variable in Prolog syntax.  Its name (by convention) 
 * must	begin with a capitol letter; that convention is NOT enforced.  
 * In Example-Generation, information is stored on each variable that constrains 
 * the kind of Individual who could be bound to this Variable.
 * 
