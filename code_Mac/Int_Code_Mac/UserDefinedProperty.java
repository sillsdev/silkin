 ...
 * be assigned to each {@link Individual} object created in the context of a 
 * particular {@link DomainTheory}.  The user defines a new property with a 
 * declaration in the header area of a Horn Clause file defining a particular 
 * {@link DomainTheory}.  
 * <p>OR the User may define a new property via the Data Gathering GUI.  
 * Under either method, a 'template' for the new user-defined property is stored 
 * on the DomainTheory object, and used each time an Individual is created.
 * </p>  <p>
 * A UserDefinedProperty is limited in the types of values it may contain; legal 
 * types are any one of the following Java built-in types (where 'xx{}' means 
 * 'a list objects of type of xx'):
 * <ul>
 * <li> int
 * </li><li> float
 * </li><li> string
