...
public class ClauseBody implements Serializable, Comparator {
    ...
    public static String[] arg0Guys = {"father", "husband", "son", "male", "brother", "half_brother",
        ...
        "allowCreation", "parents", "sibling", "siblings", "brother", "sister",
    ...
    public String toString() {
        ...
        if ((pcCounter + sCounter + starCounter) > 0) {
            path += "    Lvl=" + level + ",  PC=" + pcCounter + ", S=" + sCounter + ", *=" + starCounter + ".  ";
        }
...
//	if (kinTerm.equals("dad")) Context.breakpoint();
    ...
    public void checkValidity(Literal lit) throws KSConstraintInconsistency {
        ...
        for (int i = 0; i < body.size(); i++) {
            ...
            if ((bodyLit.predicate.name.startsWith("*"))
                ...
                udp = (UserDefinedProperty) Context.getCurrent().userDefinedProperties.get(starPredName);
                if (udp == null) {
                    // Msg for developer. Not translated.
    ...
    * 
    * CLEAN UP THIS DOC'N -- EXPLAIN OTHER ARGS
...
/*  if (Context.breakFlag) {
    ...
    public String makePCString(Individual ego, Individual alter)
        ...
        resetNodes(ego, ktd.domTh.ctxt.distinctAdrTerms);
...
//        System.out.println("\t\t########################################\n\n");
     ...
     * 
     * @param symbols  list of specific terms, like 'Fa'
     * @return      a list of generic terms, like 'P'
     * @throws KSInternalErrorException 
     */
     ...
     * 
     * @param symb  a specific term, like 'Fa'
     * @return      a generic term, like 'P'
     * @throws KSInternalErrorException 
     */
...
//  if (kinTerm.equals("daddy"))  Context.breakpoint(); 
     ...
     * are equivalent, but not equal.  For handling lists of PC-Strings, where there may be
