...
/**This class defines the math operator <code>GreaterOrEql</code>.  It's an 
 * instantiated subclass of the abstract class {@link MathOperator}. 
 * 
 *  @author		Gary Morris, Northern Virginia Community College
 *                              garymorris2245@verizon.net
*/ 
public class GreaterOrEql extends MathOperator {
	
	public GreaterOrEql() { opName = "greaterOrEql";  }
