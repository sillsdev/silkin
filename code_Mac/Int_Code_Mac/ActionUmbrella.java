...
public class ActionUmbrella extends JPanel {
    ...
    void labelComponents() {
        setBorder(javax.swing.BorderFactory.createTitledBorder(se.getString("aBoxUmbrella")));
        acceptBtn.setText(se.getString("acceptUmbrella"));
        rejectBtn.setText(se.getString("rejectUmbrella"));
        noActionBtn.setText(se.getString("noAction"));
        synonymBtn.setText(se.getString("reallySynonyms"));
        commentsScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(se.getString("notes") + ": "));
        doneBtn.setText(se.getString("dONE"));
        umbTermLabel.setText(se.getString("umbrellaTerm") + ":");
        umbTerm.setText(se.getString("20underscores"));
        subTermsLabel.setText(se.getString("sub-Terms") + ":");
        }
    ...
    private void doneBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneBtnActionPerformed
        ...
        if (!acceptBtn.isSelected() && !newSubTerms.equals(priorSubTerms)) {
            String msg = msgs.getString("onlyEditSubTerms");
            JOptionPane.showMessageDialog(papa, msg, msgs.getString("opNotAllowed"), 
        ...
        if (acceptBtn.isSelected()) {
            ...
            String msg = msgs.getString("chooseBelow");
            int ch = JOptionPane.showOptionDialog(papa, msg,
                    msgs.getString("pickPrimaryTerm"),
