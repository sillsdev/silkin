 ...
 * in this domain. This is a subclass of {@link Issue} and inherits its methods.
 *
 ...
 */
 public class ProposedDef extends Issue {
        ...
        public String typeString() { 
            return Library.screenElements.getString("proposedDefinition"); 
        }

        /**True if realDef is logically equivalent to ANY ktd in eqc.members.
         * Although all eqc members are theoretically equivalent, check them 
         * all if necessary.
         * 
         * @param realDef   a KTD to be compared to this proposed kin term def.
         * 
         * @return  true if 'realDef' is equivalent
         * 
