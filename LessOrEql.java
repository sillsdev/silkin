...
/**  This class defines the math operator <code>LessOrEql</code>.  It's an 
 * instantiated subclass of the abstract class {@link MathOperator}.  
 * 
        ...
        for (int i = 0; i < list1.size(); i++) {
            ...
            for (int j = 0; j < list2.size(); j++) {
                ...
                if ((obj2 instanceof Integer)
                        && ((((Integer) obj1).compareTo((Integer) obj2)) > 0)) {
                    return false;
                }
                if ((obj2 instanceof Float)
                        && ((((Float) obj1).compareTo((Float) obj2)) > 0)) {
                    return false;
                }
                if ((obj2 instanceof String)
                        && ((((String) obj1).compareTo((String) obj2)) > 0)) {
                    return false;
                }
            }  //  end of inner loop
