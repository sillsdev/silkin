/**This class represents an Issue where a small number of dyads don't fit a
 * pattern that seems otherwise a good fit. The criterion for "a small number"
 * is controlled in "Edit Preferences."
 *
...
public class Anomaly extends Issue {
    ...
    public Anomaly(Object base, String localKinTerm, String question, String anomalyType,
        ...
        if (base instanceof KinTermDef) {
            ...
            //  Message for developer debugging. No translation.
    ...
    public String doneList() {
        String img = msgs.getString("questionableDyadsWere");
        for (Object o : findOddballs()) {
            Dyad d = (Dyad)o;
    ...
    public void toSILKFile(PrintWriter pw) {
        ...
        try {
            if (basisType.equals("contradictions")) {
                ...
                if (obj instanceof KinTermDef) {
                    KinTermDef ktd = (KinTermDef) obj;
                    s += ktd.toSILKString(dblSpacer + spacer, true);
                } else if (obj instanceof Library.KTD_Ptr) {
                    Library.KTD_Ptr ktdPtr = (Library.KTD_Ptr) obj;
